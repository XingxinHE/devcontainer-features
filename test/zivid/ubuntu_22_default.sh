...
# 'ubuntu_22_default' scenario in 'test/test/zivid/scenarios.json'.
#
# This scenario tests the Zivid feature with Ubuntu 22.04 and default settings.
#
...
echo "Running Zivid Ubuntu 22.04 default tests..."

# Feature-specific tests
# Test that Zivid is properly installed with default settings
