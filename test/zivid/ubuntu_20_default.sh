...
# 'ubuntu_20_legacy' scenario in 'test/test/zivid/scenarios.json'.
#
# This scenario tests the Zivid feature with Ubuntu 20.04 (legacy support).
#
...
echo "Running Zivid Ubuntu 20.04 legacy tests..."

# Feature-specific tests
# Test that Zivid is properly installed on Ubuntu 20.04
